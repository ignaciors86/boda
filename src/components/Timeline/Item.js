        ...
        >
            {
                ...
                imagenes.map((image, imgIndex) => (
                    (imgIndex === currentImageIndex || imgIndex === (currentImageIndex + 1) || imgIndex === 0) && <div className="images-container elementsToHide" key={index + "item-images-" + imgIndex} >

                        <img
                            key={index + "item-image-" + imgIndex}
                            src={image}
                            alt={`Slide ${imgIndex}`}
                        ...
                        />
                        <img
                            key={index + "item-image-" + imgIndex + "-replica"}
                            src={image}
                            alt={`Slide ${imgIndex}`}
