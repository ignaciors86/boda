...
const Prompt = ({ weedding, option2=false, isOpen, uri }) => {
    const phrases1 = [
        ...
        `Te recomiendo lo último, así luce más, la verdad...`,
        ...
        `Y si has llegado hasta aquí, espero que al menos haya+s pulsado el botón para activar el audio`,
    ...
    const phrases2 = [
        ...
        `Y a Matu, por ayudarme con el hosting, y porque tiene mucha culpa,`,
        `junto a Gonzalo, de que a estas alturas disfrute tanto`,
        `de mi trabajo como para meterle estas horas por capricho`,
